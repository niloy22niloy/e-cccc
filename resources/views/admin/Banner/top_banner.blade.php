                ...
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table class="table table-bordered text-center">
                                    ...
                                    @forelse($top_banners as $key=>$top_banner)
                                    <tr>
                                        <td>{{$key+1}}</td>
                                        <td>
                                            <img src="{{asset('Banner/Top_banner/'.$top_banner->top_banner_img)}}" class="img-fluid" style="width:150px;height:150px;" alt="">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                  ...
                                                  @if($top_banner->status == 1)
                                                  <li><a class="dropdown-item" href="{{route('top_banner_turn_off',$top_banner->id)}}">Turn Off</a></li>
                                                  @elseif($top_banner->status == 0 || $top_banner->status == null)
                                                  <li><a class="dropdown-item" href="{{route('top_banner_turn_onn',$top_banner->id)}}">Turn On</a></li>
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{route('add.top_banner')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                               
                                <div class="mb-3">
                                    <label for="top_banner" class="form-label">Add Top Banner</label>
                                    <input type="file" name="top_banner" id="top_banner" class="form-control">
                                </div>
                                <div class="mb-3">
