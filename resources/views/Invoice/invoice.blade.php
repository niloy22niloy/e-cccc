                      ...
                      <tbody>
                        ...
                        <tr>
                          <td style="font-size: 12px; color: #5b5b5b; font-family: 'Open Sans', sans-serif; line-height: 18px; vertical-align: top; text-align: right;">
                            <small>ORDER</small> <a href="{{ route('pdf.download', ['order_id' => $order_id]) }}">{{$order_id}} </a><br />
              ...
              <td>
                <table width="480" border="0" cellpadding="0" cellspacing="0" align="center" class="fullPadding">
                  <tbody>
                   ...
                   $total_v = 0;
                   @endphp
                    @foreach (App\Models\OrderProdcut::where('order_id',$order_id)->get() as $item)
                    ...
                    <tr>
                      <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #ff0000;  line-height: 18px;  vertical-align: top; padding:10px 0;" class="article">
                        {{$item->product_id}}
                        <?php
                        $pro = App\Models\ProductsModel::find($item->product_id);
                        ?>
                        {{$pro->product_name}}
                      </td>
                      ...
                      <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #1e2b33;  line-height: 18px;  vertical-align: top; padding:10px 0;" align="right">TK{{$item->price}}
                        <?php
                      
                                           
                                            //  $integerValue = $item->price
                                             
                                             
                                            //  $total_v += $integerValue ; 
                                             ?>
                      </td>
                    </tr>
                    @endforeach
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e; line-height: 22px; vertical-align: top; text-align:right; white-space:nowrap;" width="80">
                        <?php
                        $orderss  = App\Models\Order::where('order_id',$order_id)->first();
                        echo $orderss->subtotal;
                        $total =  $orderss->Total;
                        $shipp = $orderss->charge;
                        
                     ?>
                  
                      </td>
                    </tr>
                    @if($orderss->coupon_name)
                    <tr>
                    ...
                    <tr>
                      ...
                      <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e; line-height: 22px; vertical-align: top; text-align:right; ">
                        <?php
                          ...
                          $coupon_dis = App\Models\Coupon::where('coupon_code',$orderss->coupon_name)->first();

                          
                          ?>
                          @if($coupon_dis->type == 1)
                           {{$coupon_dis->discount_amount}}%
                          
                          @elseif($coupon_dis->type == 2)
                          {{$coupon_dis->discount_amount}}Tk
                          @endif
                      </td>
                    </tr>
                    @endif
                    ...
                    <tr>
                      ...
                      <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #000; line-height: 22px; vertical-align: top; text-align:right; ">
                        <strong>TK{{ $orderss->Total}}</strong>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        ...
                        <table width="220" border="0" cellpadding="0" cellspacing="0" align="right" class="col">
                          <tbody>
                            ...
                            <tr>
                              @if($orderss->payment_method == 1)
                              <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; ">
                                Cash On Delivary
                              </td>
                              @elseif($orderss->payment_method == 2)
                              <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; ">
                                Pay By Card
                              </td>
                              @elseif($orderss->payment_method == 3)
                              <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; ">
                                Pay By Stripe
                              </td>
                              @endif
